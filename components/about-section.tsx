            ...
            >
              <Card className="border-0 shadow-xl bg-background/70 backdrop-blur-sm">
                <CardContent className="p-8 md:p-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      {backendExpertise.map((expertise, index) => (
                        <motion.div
                          ...
                          viewport={{ once: true }}
                          whileHover={{ x: 10, scale: 1.02 }}
                          className="flex items-start space-x-3 p-4 rounded-lg hover:bg-muted/50 transition-all duration-300 group"
                        >
                          <div className="mt-1">
                            <Server className="h-5 w-5 text-blue-600 flex-shrink-0 group-hover:scale-110 transition-transform" />
                          </div>
                          <span className="text-foreground font-medium">
                            {expertise}
                          </span>
                  ...
                  <motion.div
                    className="flex flex-wrap justify-center items-center gap-8 mt-12 pt-8 border-t border-border/50"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
